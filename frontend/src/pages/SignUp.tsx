...
function SignUp() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden py-10" style={{ backgroundColor: '#FFF8F0' }}>
      ...
      <div className="flex flex-col md:flex-row items-center gap-10 z-10">
        ...
        <div className="hidden md:block animate-bounce relative" style={{ animationDuration: '3s' }}>
        ...
        <div className="w-full max-w-md p-8 rounded-2xl border bg-white shadow-xl" style={{ borderColor: '#E5E5E5' }}>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <label className="flex items-center gap-2 cursor-pointer text-sm" style={{ color: '#14213D' }}>
              <input type="checkbox" className="w-4 h-4 accent-[#FCA311]" required />
          ...
          <p className="text-center mt-6 text-sm" style={{ color: '#14213D' }}>
            ...
            <Link to="/login" className="font-bold hover:underline" style={{ color: '#FCA311' }}>
              🔐 Sign In →
            </Link>
          </p>
        </div>
